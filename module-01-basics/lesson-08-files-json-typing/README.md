...
Ориентир: **2–4 часа** (прочитать + добавить сохранение в JSON в проект из 1.6).
...
- [ ] Данные сохраняются и читаются между запусками
- [ ] На отсутствующем/пустом `data.json` программа не падает
- [ ] Пути работают кроссплатформенно (через `pathlib.Path`)
