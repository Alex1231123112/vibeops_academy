...
Ориентир: **2–3 часа** (прочитать + сделать “устойчивый” парсер).
...
- [ ] Ловлю конкретные исключения, не прячу баги `except Exception: pass`
- [ ] Есть понятные сообщения пользователю
- [ ] Есть минимум 3 “плохих” примера входа и ожидаемое поведение
